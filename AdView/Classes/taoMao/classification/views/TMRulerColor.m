...
//        imageHead.layer.borderColor=[UIColor colorWithRed:.8 green:.8 blue:.8 alpha:1.0].CGColor;
        ...
        */
        UILabel *sl_label=[[UILabel alloc]initWithFrame:CGRectMake(10, imageLine.frame.size.height+imageLine.frame.origin.y, 40, 20)];
        sl_label.text=@"数量";
...
-(void)addShopCar:(id)sender
{
    ...
    [manager insertItem:self.productId newValue:field.text];
    showShareMessage(@"商品成功添加购物车！");
    [self performSelector:@selector(hideFromSuperview) withObject:nil afterDelay:2.0];
    }
