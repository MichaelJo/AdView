...
- (void)viewDidLoad
{
    ...
    UIImageView *image_view1 =[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"1.png"]];
    ...
    UIImageView *image_view2 =[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"2.png"]];
    ...
    UIImageView *image_view3 =[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"3.png"]];
    ...
    UIImageView *image_view4 =[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"4.png"]];
