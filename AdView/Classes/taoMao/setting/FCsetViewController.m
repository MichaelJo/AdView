...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if (alertView.tag==2) {
        if (buttonIndex==1)
        {
            ...
            ShowMessage(@"注销成功！");
            FCLoginViewController *upgrade=[[FCLoginViewController alloc]init];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (row)
    {
        case 0:
        {
            ...
            break;
            */
            AdModeViewController *avc = [[AdModeViewController alloc]init];
            [appDelegate.navigationController pushViewController:avc animated:YES];
            break;
        ...
        case 1:
        {
            ...
            */
            UserProfileViewController * feedbackViewController = [[UserProfileViewController alloc]init];
        ...
        /*case 2:
        {
            ...
            [appDelegate.navigationController pushViewController:userListViewController animated:YES];
            break;
        }
        case 3:
        {
